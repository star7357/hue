...
setup(
  ...
  entry_points = { 'desktop.sdk.application': 'NavigatorAudit=NavigatorAudit' },
  zip_safe = False,
  package_data = {
    # Include static resources.  Package_data doesn't
    # deal well with directory globs, so we enumerate
    # the files manually.
    'NavigatorAudit': expand_package_data(
      ["src/NavigatorAudit/templates", "src/NavigatorAudit/static"],
      "src/NavigatorAudit/")
  }
)
